            ...
            <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1"
                ...
                <div class="offcanvas-body align-items-lg-center">
                    ...
                    <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link scroll-link" href="{{ route('about') }}">About</a></li>
                        {{-- <li class="nav-item"><a class="nav-link scroll-link" href="#pricing">Pricing</a></li> --}}
                        <li class="nav-item"><a class="nav-link scroll-link" href="{{ route('tenagakerja') }}">Tenaga
                                Kerja</a>
                        </li>
                        <li class="nav-item"><a class="nav-link scroll-link" href="{{ route('contact') }}">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
