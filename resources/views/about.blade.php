            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="img-wrap position-relative"><img class="img-fluid rounded-4"
                        ...
                        <div class="mission-statement p-4 rounded-4 d-flex gap-4 mt-2" data-aos="fade-up" data-aos-delay="100">
                            {{-- <div class="mission-icon text-center rounded-circle"><i class="bi bi-lightbulb fs-4"></i></div> --}}
                            <div>
                                <h3 class="text-uppercase fw-bold fs-5">Misi</h3>
                                <p class="fs-6 mb-0"><i class="bi bi-caret-right-fill">Melindungi, melayani dan menyejahterakan pekerja<br></i>
                                    <i class="bi bi-caret-right-fill">Memberi rasa aman, mudah dan nyaman untuk meningkatkan produktivitas dan daya saing<br></i>
                                    <i class="bi bi-caret-right-fill">Memberi kontribusi dalam pembangunan dan perekonomian bangsa dengan tata kelola baik</i>
                                </p>
                            </div>
                        </div>
